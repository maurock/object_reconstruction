...
#         # CNN
#         CNN_layers = []
#         CNN_layers.append(DoubleConv(1, 16))                # in: 256, out:128
#         CNN_layers.append(DoubleConv(16, 16))               # in: 128, out:64
#         CNN_layers.append(DoubleConv(16, 32))               # in:64, out:64
#         CNN_layers.append(DoubleConv(32, 32))               # in:32, out:16
#         CNN_layers.append(DoubleConv(32, 64))               # in:16, out:8
#         CNN_layers.append(DoubleConv(64, 128))              # in:8, out:4
#         CNN_layers.append(DoubleConv(128, 128, last=True))  # in:4, out:2
#         self.CNN_layers = nn.Sequential(*CNN_layers)

#         # MLP
#         layers = []
#         layers.append(nn.Sequential(nn.Linear(512, 128), nn.ReLU()))
#         #layers.append(nn.Sequential(nn.Linear(256, 128), nn.ReLU()))
#         layers.append(nn.Sequential(nn.Linear(128, 75)))
#         self.fc = nn.Sequential(*layers)
